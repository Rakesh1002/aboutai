    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td align="center" style="padding:32px 16px;">
        ...
        <p style="font-size:12px;color:#71717a;margin-top:24px;">
          Sent by The AI Daily · Bangalore · written by Rakesh Roushan
        </p>
      </td></tr>
    </table>
  </body>
...
export function buildConfirmEmail(args: {
  ...
  return {
    to: args.email,
    subject: "Confirm your subscription to The AI Daily",
...
export function buildWelcomeEmail(args: {
  ...
  return {
    to: args.email,
    subject: "You're in — welcome to The AI Daily",
    html: wrapHtml({ preheader, bodyHtml }),
    text,
...
export function buildUnsubscribeReceipt(args: { email: string }): SendArgs {
  const preheader = "You've been unsubscribed from The AI Daily.";
  const bodyHtml = `
    <h1 style="font-size:22px;margin:0 0 16px;color:#18181b;">Unsubscribed.</h1>
    <p style="margin:0 0 16px;">You won't get any more emails from The AI Daily. No follow-ups, no "are you sure" sequence.</p>
    <p style="margin:0 0 16px;color:#71717a;font-size:13px;">If this was a mistake, you can resubscribe any time at the homepage.</p>
  `;
  const text =
    `Unsubscribed.\n\n` +
    `You won't get any more emails from The AI Daily. No follow-ups, no "are you sure" sequence.\n\n` +
    `If this was a mistake, resubscribe at the homepage.\n`;
  return {
    to: args.email,
    subject: "You've been unsubscribed from The AI Daily",
    html: wrapHtml({ preheader, bodyHtml }),
    text,
  };
}
