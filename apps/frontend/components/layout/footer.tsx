...
const footerLinks = {
  ...
  verticals: [
    { name: "AgTech", href: "/tools?vertical=agtech" },
    { name: "Legal", href: "/tools?vertical=legal" },
    { name: "DevTools", href: "/tools?vertical=devtools" },
    { name: "Marketing", href: "/tools?vertical=marketing" },
  ],
  company: [
    { name: "About", href: "/about" },
    { name: "Manifesto", href: "/news/end-of-wrapper-era" },
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-zinc-200 pt-8 dark:border-zinc-800 md:flex-row">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            © {new Date().getFullYear()} aboutai. All rights reserved.
          </p>

          <div className="flex items-center gap-4">
            <a
              href="https://twitter.com/aboutai"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/aboutai"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300"
            >
